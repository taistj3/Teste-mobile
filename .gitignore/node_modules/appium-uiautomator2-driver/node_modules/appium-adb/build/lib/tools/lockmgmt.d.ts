...
export type LockManagementCommands = typeof lockManagementMethods;
declare namespace lockManagementMethods {
     ...
     */
    function isLockManagementSupported(this: import("../adb.js").ADB): Promise<boolean>;
    /**
     ...
     */
    function verifyLockCredential(this: import("../adb.js").ADB, credential?: string | null): Promise<boolean>;
    /**
     ...
     */
    function clearLockCredential(this: import("../adb.js").ADB, credential?: string | null): Promise<void>;
    /**
     ...
     * @throws {Error} If operation faces an unexpected error
     */
    function isLockEnabled(this: import("../adb.js").ADB): Promise<boolean>;
    /**
     ...
     * the credential
     */
    function setLockCredential(this: import("../adb.js").ADB, credentialType: string, credential: string, oldCredential?: string | null): Promise<void>;
    /**
     ...
     */
    function isScreenLocked(this: import("../adb.js").ADB): Promise<boolean>;
    /**
     * Dismisses keyguard overlay.
     * @this {import('../adb.js').ADB}
     */
    function dismissKeyguard(this: import("../adb.js").ADB): Promise<void>;
    /**
     ...
     * @this {import('../adb.js').ADB}
     */
    function cycleWakeUp(this: import("../adb.js").ADB): Promise<void>;
}
