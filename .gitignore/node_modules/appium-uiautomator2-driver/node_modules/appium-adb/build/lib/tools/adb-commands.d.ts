...
declare namespace methods {
     ...
     */
    function grantAllPermissions(this: import("../adb.js").ADB, pkg: string, apk?: string): Promise<void>;
    /**
     ...
     * @throws {Error} If there was an error while changing permissions.
     */
    function getGrantedPermissions(this: import("../adb.js").ADB, pkg: string, cmdOutput?: string | null): Promise<string[]>;
    /**
     ...
     */
    function getDeniedPermissions(this: import("../adb.js").ADB, pkg: string, cmdOutput?: string | null): Promise<string[]>;
    /**
     ...
     */
    function getReqPermissions(this: import("../adb.js").ADB, pkg: string, cmdOutput?: string | null): Promise<string[]>;
    /**
     ...
     */
    function setHiddenApiPolicy(this: import("../adb.js").ADB, value: number | string, ignoreError?: boolean): Promise<void>;
    /**
     ...
     *                 command on the device under test.
     */
    function setDefaultHiddenApiPolicy(this: import("../adb.js").ADB, ignoreError?: boolean): Promise<void>;
    /**
     ...
     */
    function clearTextField(this: import("../adb.js").ADB, length?: number): Promise<void>;
    /**
     ...
     * options.
     */
    function pull(this: import("../adb.js").ADB, remotePath: string, localPath: string, opts?: import("teen_process").TeenProcessExecOptions): Promise<void>;
    /**
     ...
     */
    function startLogcat(this: import("../adb.js").ADB, opts?: import("../logcat.js").LogcatOpts): Promise<void>;
    /**
     ...
     *
     * @this {import('../adb.js').ADB}
     * @return {import('../logcat').LogEntry[]} The collected logcat output.
     * @throws {Error} If logcat process is not running.
     */
    function getLogcatLogs(this: import("../adb.js").ADB): import("../logcat").LogEntry[];
    /**
     * Listener function, which accepts one argument.
     *
     * The argument is a log record object with `timestamp`, `level` and `message` properties.
     ...
     */
    function setDeviceProperty(this: import("../adb.js").ADB, prop: string, val: string, opts?: SetPropOpts): Promise<void>;
    /**
     * @this {import('../adb.js').ADB}
     ...
     */
    function bugreport(this: import("../adb.js").ADB, timeout?: number): Promise<string>;
    /**
     ...
     */
    function screenrecord(this: import("../adb.js").ADB, destination: string, options?: ScreenrecordOptions): SubProcess;
    /**
     ...
     */
    function setWifiState(this: import("../adb.js").ADB, on: boolean, isEmulator?: boolean): Promise<void>;
    /**
     ...
     *                                       is an emulator rather than a real device.
     */
    function setDataState(this: import("../adb.js").ADB, on: boolean, isEmulator?: boolean): Promise<void>;
    /**
     ...
     */
    function listPorts(this: import("../adb.js").ADB, family?: PortFamily): Promise<PortInfo[]>;
}
