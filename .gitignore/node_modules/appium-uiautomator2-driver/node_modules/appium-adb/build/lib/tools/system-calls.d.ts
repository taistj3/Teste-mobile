...
declare namespace systemCallMethods {
     ...
     */
    function getConnectedDevices(this: import("../adb.js").ADB, opts?: ConnectedDevicesOptions): Promise<Device[]>;
    /**
     ...
     */
    function reconnect(this: import("../adb.js").ADB, target?: string): Promise<void>;
    /**
     ...
     */
    function adbExec<TExecOpts extends import("teen_process").TeenProcessExecOptions & ShellExecOptions & SpecialAdbExecOptions>(this: import("../adb.js").ADB, cmd: string | string[], opts?: TExecOpts): Promise<TExecOpts extends TFullOutputOption ? import("teen_process").TeenProcessExecResult<any> : string>;
    /**
     ...
     * @throws {Error} If the command returned non-zero exit code.
     */
    function shell<TShellExecOpts extends ShellExecOptions>(this: import("../adb.js").ADB, cmd: string | string[], opts?: TShellExecOpts): Promise<TShellExecOpts extends TFullOutputOption ? import("teen_process").TeenProcessExecResult<any> : string>;
    /**
     *
     * @this {import('../adb.js').ADB}
     * @param {string[]} [args=[]]
     ...
     */
    function createSubProcess(this: import("../adb.js").ADB, args?: string[]): import("teen_process").SubProcess;
    /**
     ...
     * @return {Promise<Device[]>} The list of connected devices.
     */
    function getConnectedEmulators(this: import("../adb.js").ADB, opts?: ConnectedDevicesOptions): Promise<Device[]>;
    /**
     ...
     */
    function getRunningAVDWithRetry(this: import("../adb.js").ADB, avdName: string, timeoutMs?: number): Promise<Device | null>;
    /**
     ...
     */
    function killEmulator(this: import("../adb.js").ADB, avdName?: string | null, timeout?: number): Promise<boolean>;
    /**
     ...
     */
    function launchAVD(this: import("../adb.js").ADB, avdName: string, opts?: AvdLaunchOptions): Promise<SubProcess>;
     ...
     */
    function waitForEmulatorReady(this: import("../adb.js").ADB, timeoutMs?: number): Promise<void>;
    /**
     ...
     */
    function waitForDevice(this: import("../adb.js").ADB, appDeviceReadyTimeout?: number): Promise<void>;
    /**
     ...
     */
    function reboot(this: import("../adb.js").ADB, retries?: number): Promise<void>;
    /**
     ...
     *                          does not exist.
     */
    function ls(this: import("../adb.js").ADB, remotePath: string, opts?: string[]): Promise<string[]>;
    /**
