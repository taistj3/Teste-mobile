...
export type ApkCreationOptions = {
    /**
...
export type AabUtils = typeof aabUtilsMethods;
declare namespace aabUtilsMethods {
     ...
     */
    function extractUniversalApk(this: import("../adb.js").ADB, aabPath: string, opts?: ApkCreationOptions): Promise<string>;
}
