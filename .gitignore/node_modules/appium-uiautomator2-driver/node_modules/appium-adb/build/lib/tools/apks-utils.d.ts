...
declare namespace apksUtilsMethods {
     ...
     * executing it
     */
    function execBundletool(this: import("../adb.js").ADB, args: Array<string>, errorMsg: string): Promise<string>;
    /**
     *
     * @this {import('../adb.js').ADB}
     ...
     */
    function getDeviceSpec(this: import("../adb.js").ADB, specLocation: string): Promise<string>;
    /**
     ...
     */
    function installMultipleApks(this: import("../adb.js").ADB, apkPathsToInstall: Array<string>, options?: InstallMultipleApksOptions): Promise<string>;
    /**
     ...
     */
    function installApks(this: import("../adb.js").ADB, apks: string, options?: InstallApksOptions): Promise<void>;
    /**
     ...
     */
    function extractBaseApk(this: import("../adb.js").ADB, apks: string): Promise<string>;
    /**
     ...
     * @throws {Error} If there was an error while extracting/finding the file
     */
    function extractLanguageApk(this: import("../adb.js").ADB, apks: string, language?: string | null): Promise<string>;
    /**
     *
     * @param {string} output
     * @returns {boolean}
