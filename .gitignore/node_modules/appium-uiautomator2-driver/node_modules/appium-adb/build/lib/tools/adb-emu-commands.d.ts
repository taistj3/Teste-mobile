...
declare namespace emuMethods {
     ...
     */
    function powerAC(this: import("../adb.js").ADB, state?: PowerAcStates): Promise<void>;
    /**
     ...
     */
    function powerCapacity(this: import("../adb.js").ADB, percent?: string | number): Promise<void>;
    /**
     ...
     */
    function sendSMS(this: import("../adb.js").ADB, phoneNumber: string | number, message?: string): Promise<void>;
    /**
     ...
     */
    function gsmSignal(this: import("../adb.js").ADB, strength?: GsmSignalStrength): Promise<void>;
    /**
     ...
     */
    function gsmVoice(this: import("../adb.js").ADB, state?: GsmVoiceStates): Promise<void>;
    /**
     ...
     */
    function networkSpeed(this: import("../adb.js").ADB, speed?: NetworkSpeed): Promise<void>;
    /**
     ...
     */
    function execEmuConsoleCommand(this: import("../adb.js").ADB, cmd: string[] | string, opts?: ExecTelnetOptions): Promise<string>;
    /**
