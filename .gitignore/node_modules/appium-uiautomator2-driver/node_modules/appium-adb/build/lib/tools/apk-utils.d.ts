...
declare namespace apkUtilsMethods {
     ...
     */
    function isAppInstalled(this: import("../adb.js").ADB, pkg: string, opts?: IsAppInstalledOptions): Promise<boolean>;
    /**
     ...
     */
    function startUri(this: import("../adb.js").ADB, uri: string, pkg?: string | null, opts?: StartUriOptions): Promise<void>;
    /**
     ...
     */
    function waitForActivityOrNot(this: import("../adb.js").ADB, pkg: string, activity: string, waitForStop: boolean, waitMs?: number): Promise<void>;
    /**
     ...
     * @throws {error} If timeout happens.
     */
    function waitForActivity(this: import("../adb.js").ADB, pkg: string, act: string, waitMs?: number): Promise<void>;
    /**
     ...
     * @throws {error} If timeout happens.
     */
    function waitForNotActivity(this: import("../adb.js").ADB, pkg: string, act: string, waitMs?: number): Promise<void>;
    /**
     ...
     */
    function uninstallApk(this: import("../adb.js").ADB, pkg: string, options?: UninstallOptions): Promise<boolean>;
    /**
     ...
     */
    function installFromDevicePath(this: import("../adb.js").ADB, apkPathOnDevice: string, opts?: import("./system-calls.js").ShellExecOptions): Promise<void>;
    /**
     ...
     */
    function cacheApk(this: import("../adb.js").ADB, apkPath: string, options?: CachingOptions): Promise<string>;
    /**
     ...
     */
    function install(this: import("../adb.js").ADB, appPath: string, options?: InstallOptions): Promise<void>;
    /**
     ...
     */
    function getApplicationInstallState(this: import("../adb.js").ADB, appPath: string, pkg?: string | null): Promise<InstallState>;
    /**
     ...
     */
    function installOrUpgrade(this: import("../adb.js").ADB, appPath: string, pkg?: string | null, options?: InstallOrUpgradeOptions): Promise<InstallOrUpgradeResult>;
    /**
     ...
     */
    function extractStringsFromApk(this: import("../adb.js").ADB, appPath: string, language?: string | null, outRoot?: string | null): Promise<ApkStrings>;
    /**
     ...
     */
    function ensureCurrentLocale(this: import("../adb.js").ADB, language?: string, country?: string, script?: string): Promise<boolean>;
    /**
